  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      try {
        ...
        logError(error, 'Processing review callback');
        showNotification('Failed to publish review', 'error');
        navigate(returnPath);
      }
    };
  ...
  return (
    <div className="min-h-screen bg-[#1a1f2e] flex items-center justify-center">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold mb-4">Processing your review...</h1>
        <p className="text-gray-400">Please wait while we publish your review.</p>
      </div>
    </div>
  );
};

export default ReviewCallback;